...
export async function setContext(app, context) {
  ...
  if (!app.context) {
    app.context = {
      ...
      error: context.error,
      base: '/',
      env: {"APIKEY":"AIzaSyBBy5wGzdJu44pz4pLp1jGhS9xVjQ-Bj5w","AUTHDOMAIN":"cardversus.firebaseapp.com","DATABASEURL":"https://cardversus.firebaseio.com","PROJECTID":"cardversus","STORAGEBUCKET":"cardversus.appspot.com","MESSAGINGSENDERID":"111647879834"}
    }
    // Only set once
    if (context.req) {
